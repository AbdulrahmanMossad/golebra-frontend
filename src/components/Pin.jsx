  ...
  return (
    <div className="m-2 hover:scale-105 ">
      <div
        ...
        className=" relative cursor-zoom-in w-auto shadow-md hover:shadow-lg rounded-lg overflow-hidden transition-all duration-500 ease-in-out "
      >
        {image && (
          <img
      ...
      >
        <img
          ...
          alt="user-profile"
        />
        <p className="font-semibold capitalize icon">{postedBy?.userName}</p>
      </Link>
    </div>
  );
};
